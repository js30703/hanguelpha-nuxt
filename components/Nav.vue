...
.Nav {
  @extend .center;
  @include responsive(hieght, (50px, 60px, 80px));
  ...
  &-ctn {
    ...
    .logo {
      @include responsive(margin-left, (10px, 10px, 30px));
      cursor: pointer;
      img {
        @include responsive(width, (25px, 25px, 30px));
    ...
    .items {
      ...
      a {
        @extend .center;
        @include responsive(font-size, (1.5rem, 1.5rem, 1.6rem));
        height: 100%;
